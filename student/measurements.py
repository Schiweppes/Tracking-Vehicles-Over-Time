...
class Sensor:
    ...
    def in_fov(self, x):
        ...
        if p_sens[0] > 0: # point is in front of the sensor
    ...
    def get_hx(self, x):    
        ...
        if self.name == 'lidar':
            ...
            if sens[0] == 0:
                ...
                measurement_arr = np.zeros((2,1))
                measurement_arr[0,0] = self.c_i - self.f_i * sens[1] / sens[0]
                measurement_arr[1,0] = self.c_j - self.f_j * sens[2] / sens[0]
...
class Measurement:
    ...
    def __init__(self, num_frame, z, sensor):
        ...
        if sensor.name == 'lidar':
            ...
            self.R = np.matrix([[params.sigma_cam_i**2, 0],  # covariance matrix
